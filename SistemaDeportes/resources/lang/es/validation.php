...
return [
    ...
    */
    ...
    'regex'                => 'El formato de :attribute es inválido, solo debe contener letras.',
    ...
    */
    ...
    'attributes' => [
        ...
        'nombre'                            => 'Nombres *',
        'apellido'                          => 'Apellidos *',
        'id_linea_telefono'                 =>'Linea *',
        'id_linea_telefono_emergencia'      =>'Linea *',
        'id_unidad_academica'               => "unidad académica *",
        'lu'                                => 'LU Nº *',
        'certificado_medico_estudiante'     => 'certificado médico',
        'fecha_de_emision_certificado_estudiante'   => 'fecha de emisión ',
        'legajo'                                    => 'Legajo Nº *',
        'lugar_de_trabajo'                          => 'lugar de trabajo *',
        'certificado_medico_profesional'            => 'certificado médico',
        'fecha_de_emision_certificado_profesional'   => 'fecha de emisión ',
        'nombre_familiar'                           => 'nombre de familiar vinculado a la UNSa ',
        'legajo_familiar'                           => 'Nº Legajo de familiar vinculado a la UNSa ',
