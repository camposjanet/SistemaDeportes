                    ...
                    <td style="width: 50%; vertical-align: top;">
                        <table class="table-bordered1" style="border-bottom:2px; width:340px;height: 45px;float: left;">
                            <tbody >
                                ...
                                <tr >
                                    @if($ficha->categoria== 'Docente')
                                        <td colspan="3" style="height: 20px;">  Categoría: DOCENTE</td>
                                    @else
                                        <td colspan="3" style="height: 20px;">  Categoría: PAU</td>
                                    @endif
                        ...
                        <table class="table-bordered2" style="border-bottom:2px; width:340px;height: 183px;">
                            <tbody >
                                ...
                                <tr><td style="font-size: 0.8em;" > Legajo: {{$ficha->legajo}}
                                    </td>
                                </tr>
                                <tr><td style="font-size: 0.8em;">Lugar de trabajo: {{$ficha->lugar}} 
                                    </td>
                                </tr>
                                <tr>
