                    ...
                    <td style="width: 50%; vertical-align: top;">
                        <table class="table-bordered1" style="border-bottom:2px; width:340px;height: 45px;float: left;">
                            <tbody >
                                ...
                                <tr >
                                    <td colspan="3" style="height: 20px;">  Categoría: FAMILIAR</td>
                                </tr>
                            </tbody>
                        </table> 
                        <table class="table-bordered2" style="border-bottom:2px; width:340px;height: 183px;">
                            <tbody >
                                <tr >
                                    <td style="width:100px;border-bottom: 1px solid; vertical-align: top;" rowspan="4">
                                ...
                                <tr><td style="font-size: 0.8em;" >Legajo de familiar vinculado a la UNSa: {{$documentacion->legajo_familiar}}
                                    </td>
                                </tr>
                                <tr>
                                    <td style="height: 37px; font-size: 0.5em; vertical-align: bottom; text-align: center; border-bottom: 1px solid;"> Resp. de Deportes
                                    </td>
                                </tr>
                            </tbody>
                        </table>
